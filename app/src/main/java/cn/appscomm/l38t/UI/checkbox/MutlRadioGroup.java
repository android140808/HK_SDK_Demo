package cn.appscomm.l38t.UI.checkbox;
...
public class MutlRadioGroup extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public MutlRadioGroup(Context context) {
        super(context);
        init();
    }
     ...
     * {@inheritDoc}
     */
    public MutlRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * @attr ref android.R.styleable#MutlRadioGroup_checkedButton
     * @see #check(int)
     * @see #clearCheck()
     */
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MutlRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MutlRadioGroup.LayoutParams;
    }
